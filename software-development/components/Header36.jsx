    ...
    >
      <div className="mx-[5%] sm:max-w-md md:justify-self-start lg:mr-20 lg:ml-[5vw] lg:justify-self-end">
        <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
          Inovasi Terdepan dalam Pengembangan Perangkat Lunak
        </h1>
        <p className="md:text-md">
          Kami menawarkan solusi pengembangan perangkat lunak yang dirancang
          khusus untuk memenuhi kebutuhan bisnis Anda. Temukan bagaimana
          teknologi dapat meningkatkan efisiensi dan produktivitas perusahaan
          Anda.
        </p>
