      ...
      <div className="container flex flex-col items-center">
        <div className="rb-12 mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
            Solusi IT untuk Semua Jenis Bisnis
          </h1>
          <p className="md:text-md">
            Kami menyediakan layanan konsultasi IT yang dirancang khusus untuk
            memenuhi kebutuhan unik setiap bisnis, mulai dari startup hingga
            perusahaan besar. Dengan pendekatan yang inovatif dan berbasis data,
            kami membantu Anda mengoptimalkan proses dan meningkatkan efisiensi.
          </p>
